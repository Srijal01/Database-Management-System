...
SELECT D.Dnumber, D.Dname, E.FName, E.LName FROM DEPARTMENT D
JOIN EMPLOYEE E ON D.Dnumber = E.Dno ORDER BY D.Dnumber;

--b) Write a query to display LEFT OUTER JOIN of EMPLOYEE and DEPARTMENT table where manager employee number are same.
SELECT E.FName, E.LName, D.Dname, D.Mgr_ssn FROM EMPLOYEE E
...
SELECT D.Dname, D.Dnumber, E.FName, E.LName, E.Ssn FROM DEPARTMENT D
RIGHT JOIN EMPLOYEE E ON D.Mgr_ssn = E.Ssn;

--d) Write a query to display FULL OUTER JOIN of EMPLOYEE and PROJECT table.
SELECT E.FName, E.LName, P.PName, P.PLocation FROM EMPLOYEE E
...
SUM(E.Salary) AS Total_Salary FROM DEPARTMENT D
